  ...
  return (
    <Screen>
      ...
      >
        ...
        {/* --- TMDB (Películas) --- */}
        <View className="mb-8 p-6 bg-gray-800 rounded-xl border border-gray-700 items-center">
          
          {/* LOGO SVG DE TMDB */}
          <View className="mb-4">
            <Svg width={150} height={64} viewBox="0 0 191 82">
                <Path 
                    fill="#90cea1" 
          ...
          <Text className="text-gray-300 text-sm text-center mb-2 px-2">
            This product uses the TMDB API but is not endorsed or certified by TMDB.
          </Text>
          <Text className="text-gray-500 text-xs text-center italic mb-4">
          ...
          <TouchableOpacity onPress={() => openLink("https://www.themoviedb.org/")}>
            <Text className="text-blue-400 font-semibold">Visitar sitio web</Text>
          </TouchableOpacity>
        </View>

        {/* --- TVMaze (Series) --- */}
        <View className="mb-6 p-4 bg-gray-800 rounded-xl border border-gray-700">
          <Text className="text-xl font-bold text-yellow-400 mb-2">TVMaze</Text>
          ...
          <TouchableOpacity onPress={() => openLink("https://www.tvmaze.com/")}>
            <Text className="text-blue-400 underline">Visitar TVMaze</Text>
          </TouchableOpacity>
        </View>

        {/* --- IGDB (Juegos) --- */}
        <View className="mb-6 p-4 bg-gray-800 rounded-xl border border-gray-700">
          <Text className="text-xl font-bold text-purple-400 mb-2">IGDB</Text>
          <Text className="text-gray-300 text-sm mb-3">
            Información de videojuegos provista por IGDB.
          </Text>
          <TouchableOpacity onPress={() => openLink("https://www.igdb.com/")}>
            <Text className="text-blue-400 underline">Visitar IGDB</Text>
          </TouchableOpacity>
        </View>

        {/* --- Apple (Música y Libros) --- */}
        <View className="mb-6 p-4 bg-gray-800 rounded-xl border border-gray-700">
          <Text className="text-xl font-bold text-gray-200 mb-2">Apple Music & Books</Text>
          <Text className="text-gray-300 text-sm mb-3">
            Datos proporcionados por Apple. Copyright © 2024 Apple Inc.
          </Text>
          <TouchableOpacity onPress={() => openLink("https://www.apple.com/itunes/")}>
            <Text className="text-blue-400 underline">Apple Services</Text>
          </TouchableOpacity>
        </View>
