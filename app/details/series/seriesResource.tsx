      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="flex-row items-center justify-between px-4 pt-2 pb-4">
          <View className="flex-row items-center flex-1">
            <ReturnButton route="/Collection" title={'Detalle de la serie'} style={" "} params={{initialResource: 'Series'}}/>
          </View>
          <TouchableOpacity 
            onPress={handleEdit}
        ...
        <View className="px-4 mb-4">
          <Image source={{ uri: contenidoserie.imagenUrl || 'https://via.placeholder.com/500x750' }} className="w-full h-[500px] rounded-2xl bg-background" resizeMode="cover" />
        </View>
