    ...
    return (
        <View className=" flex-1 mb-4">
            ...
            <View className="flex-row items-stretch flex-wrap gap-2">
                ...
                {/* Estado */}
                <View className="px-3 py-1.5 rounded-lg justify-center" style={{backgroundColor: `${getStatusColor(resource.estado)}33`}}>
                <Text className="text-sm font-semibold uppercase" style={{ color: getStatusColor(resource.estado) }}>
                ...
                {!!getDificulty(resource) && (
                    <View className='flex-row px-3 py-1.5 rounded-lg justify-between items-center' style={{backgroundColor: `${getDificultyColor(getDificulty(resource))}33`}}>
                        <DificultyIcon color={getDificultyColor(getDificulty(resource))}/>    
                        <Text className="text-semibold text-xs ml-1" style={{color: getDificultyColor(getDificulty(resource))}}>{getDificulty(resource)}</Text>
                    </View>
                )}
