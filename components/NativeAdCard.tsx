          ...
          <LinearGradient
            ...
            <View className="p-4">
              ...
              <View
                ...
                <AppText style={{ color: colors.primary, fontSize: 10, fontWeight: 'bold' }}>
                  {t('components.sponsored')}
                </AppText>
              </View>
                            ...
                            {[1, 2, 3, 4, 5].map((star) => {
                              ...
                              return (
                                <ScalableFontAwesome5
                                  ...
                                  size={12}
                                  color={
                                    rating >= star - 0.5 ? colors.rating : colors.secondaryText
                                  }
                                />
                              );
                            })}
                    ...
                    <View style={{ marginTop: 8, alignSelf: 'flex-start' }}>
                      <NativeAsset assetType={NativeAssetType.CALL_TO_ACTION}>
                        <View
                          ...
                          <AppText
                            style={{ color: colors.primaryText, fontWeight: 'bold', fontSize: 12 }}>
                            {nativeAd.callToAction}
                          </AppText>
                        </View>
                      </NativeAsset>
              ...
              <View className="flex-1 flex-col">
                <NativeAsset assetType={NativeAssetType.ADVERTISER}>
                  <AppText
                    ...
                    style={{ color: colors.primaryText, fontSize: 14 }}
                    numberOfLines={1}>
                    {nativeAd.advertiser || t('components.thirdPartyAd')}
                  </AppText>
                </NativeAsset>
                <AppText style={{ color: colors.secondaryText, fontSize: 12 }}>
                  {t('components.recommendedForYou')}
                </AppText>
              </View>
            </View>
          </View>
